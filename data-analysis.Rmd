...
x <- as.data.frame(as.numeric(as.character(filteredColumns$rp.hourss[filteredColumns$rd.rp.stid == 4])))
za7ma <- filteredColumns[filteredColumns$rd.rp.stid == 4,]
za7ma$hour <- as.numeric(za7ma$rp.hourss)

mafeesh <- filteredColumns[filteredColumns$rd.rp.stid ==5, ]
mafeesh$hour <- as.numeric(mafeesh$rp.hourss)
y <- as.data.frame(as.numeric(as.character(filteredColumns$rp.hourss[filteredColumns$rd.rp.stid == 5])))
...
```{r}
accident = filteredColumns[filteredColumns$rd.rp.stid == 8,]
